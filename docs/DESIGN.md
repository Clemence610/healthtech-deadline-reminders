...
> Design notes for **healthtech-deadline-reminders** — a runnable python example that Schedule weekday healthtech deadline reminders and publish their payloads to a queue.
...
- **Feature code** — the actual task: deadline-reminders.
